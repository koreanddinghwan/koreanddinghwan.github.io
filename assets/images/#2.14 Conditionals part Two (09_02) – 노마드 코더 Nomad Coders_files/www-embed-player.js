...
m.toJSON=function(){var a=this.T();return Nc(a,Pc)};
m.T=function(){if(this.j){if(this.i){var a=this.map,b;for(b in a)if(Object.prototype.hasOwnProperty.call(a,b)){var c=a[b].h;c&&c.T()}}}else{this.h.length=0;a=Uc(this);a.sort();for(b=0;b<a.length;b++){c=this.map[a[b]];var d=c.h;d&&d.T();this.h.push([c.key,c.value])}this.j=!0}return this.h};
...
m.set=function(a,b){var c=new Tc(a);this.i?(c.h=b,c.value=b.T()):c.value=b;this.map[a.toString()]=c;this.j=!1;return this};
...
Yc.prototype.toJSON=function(){var a=this.T();return Nc(a,Pc)};
Yc.prototype.T=function(){if(this.h)for(var a in this.h){var b=this.h[a];if(Array.isArray(b))for(var c=0;c<b.length;c++)b[c]&&b[c].T();else b&&b.T()}return this.i};
Yc.prototype.toString=function(){return this.T().toString()};
Yc.prototype.clone=function(){var a=this.constructor,b=Nc(this.T(),Qc);Xc=b;a=new a(b);Xc=null;fd(a,this);return a};
...
m.set=function(a,b,c){var d=!1;if("object"===typeof c){var e=c.Vm;d=c.secure||!1;var f=c.domain||void 0;var g=c.path||void 0;var h=c.Qa}if(/[;=\s]/.test(a))throw Error('Invalid cookie name "'+a+'"');if(/[;\r\n]/.test(b))throw Error('Invalid cookie value "'+b+'"');void 0===h&&(h=-1);c=f?";domain="+f:"";g=g?";path="+g:"";d=d?";secure":"";h=0>h?"":0==h?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date(Date.now()+1E3*h)).toUTCString();this.h.cookie=a+"="+b+c+g+h+d+(null!=e?";samesite="+
e:"")};
...
function qi(a,b,c,d){d=void 0===d?{}:d;if(N("lr_drop_other_and_business_payloads")){if(zg[a]||yg[a])return}else if(N("lr_drop_other_payloads")&&zg[a])return;var e={},f=Math.round(d.timestamp||O());e.eventTimeMs=f<Number.MAX_SAFE_INTEGER?f:0;e[a]=b;a=Yg();e.context={lastActivityMs:String(d.timestamp||!isFinite(a)?-1:a)};N("log_sequence_info_on_gel_web")&&d.fa&&(a=e.context,b=d.fa,pi[b]=b in pi?pi[b]+1:0,a.sequence={index:pi[b],groupKey:b},d.zb&&delete pi[d.fa]);(d.Wm?ii:ei)({endpoint:"log_event",payload:e,
...
g,f);return b}
function Ci(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||F("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.Lm||F("AUTHORIZATION"))||(a?b="Bearer "+C("gapi.auth.getToken")().Km:b=Sd([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=F("SESSION_INDEX",0),N("pageid_as_header_web")&&(d["X-Goog-PageId"]=F("DELEGATED_SESSION_ID")));return d}
...
a);
if("AbortError"===e.name)return new Q("UNKNOWN_ABORT",a,e.message);e.args=[Object.assign(Object.assign({},a),{name:"IdbError",Sm:e.name})];e.level="WARNING";return e}
...
El();c=u(a.da);for(d=c.next();!d.done;d=c.next())if(d=d.value,l.message&&l.message.match(d.Rm)){a=d.weight;break a}a=u(a.Z);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.Ya(l)){a=c.weight;break a}a=1}l.sampleWeight=a;a=u(zl);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.Ca[l.name])for(e=u(c.Ca[l.name]),d=e.next();!d.done;d=e.next())if(f=d.value,d=l.message.match(f.regexp)){l.params["params.error.original"]=d[0];e=f.groups;f={};for(g=0;g<e.length;g++)f[e[g]]=d[g+1],l.params["params.error."+e[g]]=
...
return a.join("")}
;var mm,nm=y.ytLoggingDocDocumentNonce_;nm||(nm=lm(),Ua("ytLoggingDocDocumentNonce_",nm));mm=nm;var om={vf:0,Pc:1,Xc:2,Fi:3,xf:4,rm:5,uj:6,Mk:7,rk:8,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE",8:"PUSH_NOTIFICATIONS"};function pm(a){this.h=a}
...
function In(a,b,c){c=void 0===c?{}:c;c.layer||(c.layer=0);var d=void 0!==c.Nb?c.Nb:c.layer;var e=wm(d);d=um(d);var f;d&&(void 0!==c.parentCsn?f={clientScreenNonce:c.parentCsn,visualElement:d}:e&&"UNDEFINED_CSN"!==e&&(f={clientScreenNonce:e,visualElement:d}));var g,h=F("EVENT_ID");"UNDEFINED_CSN"===e&&h&&(g={servletData:{serializedServletEventId:h}});try{var k=a.client;h=f;var l=c.bb,n=c.cttAuthInfo,p=c.Pm,r=Dm(),q={csn:r,pageVe:(new pm({veType:b,youtubeData:g})).getAsJson()};h&&h.visualElement?(q.implicitGesture=
{parentCsn:h.clientScreenNonce,gesturedVe:h.visualElement.getAsJson()},p&&(q.implicitGesture.gestureType=p)):h&&Rl(new Qi("newScreen() parent element does not have a VE - rootVe",b));l&&(q.cloneCsn=l);l={cttAuthInfo:n,fa:r};k?qi("screenCreated",q,k,l):V("screenCreated",q,l);rk(uk,new Am(r));var z=r}catch(B){Tl(B,{Um:b,rootVe:d,parentVisualElement:void 0,Om:e,Tm:f,bb:c.bb});Sl(B);return}zm(z,b,c.layer,c.cttAuthInfo);if((b=e&&"UNDEFINED_CSN"!==e&&d)&&!(b=N("screen_manager_skip_hide_killswitch"))){a:{b=
